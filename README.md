...
Secondly, if one considers executing R scripts using HPC then 'parallel programming' refers to the way we also run these R scripts, so different techniques are needed in that case.  
